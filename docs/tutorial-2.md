...
1. Append the following OML code, which adds the concept of a `Mission` with the relation `Purses` to the existing concept of `Objective`, to the body of the `mission` vocabulary. Save the editor.
